...
token_path = "C:\\Users\\rap\\Desktop\\Spyder\\Algo Bot One\\api_key.txt"
client = oandapyV20.API(access_token=open(token_path, 'r').read(),environment="practice")
account_id = "101-001-26544002-001"

pairs = ["EUR_USD", "USD_CAD", "AUD_USD", "GBP_USD"]
...
def candles(instrument):
    params = {"count": 250, "granularity": "M%"}
    ...
    ohlc_df = ohlc.df.apply(pd.to_numeric)
    return ohlc_df

def market_order(instrument, units, sl):
    """units of pos is buy, negative is sell"""
